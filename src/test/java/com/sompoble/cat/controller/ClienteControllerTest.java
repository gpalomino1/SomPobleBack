...
public class ClienteControllerTest {
    ...
    @Test
    public void testCreateClienteConflict() throws Exception {
        Cliente cliente = new Cliente();
        cliente.setDni("12345678A");
        cliente.setNombre("Juan");
        cliente.setApellidos("Perez");
    ...
    public void testUpdateCliente() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/clientes/12345678A")
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.nombre").value("Juan Updated"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.apellidos").value("Perez Updated"));
